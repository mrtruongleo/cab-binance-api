...
export default opts => {
  ...
  return {
    getConvertPairSupported: payload=> pCall ('/sapi/v1/convert/exchangeInfo', payload, 'GET'),
    getConvertQuotes: payload=> pCall ('/sapi/v1/convert/getQuote', payload, 'POST'),
    acceptConvert: payload=> pCall ('/sapi/v1/convert/acceptQuote', payload, 'POST'),
