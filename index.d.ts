...
declare module 'binance-api-react-native' {
    ...
    export interface ConvertPairSupport {
    status: string,
    code: string,
    data: {
        coin: string,
    ...
    export type GetConvertQuotesRes = {
    quoteId:string,
    ratio:string,
    inverseRatio:string,
    ...
    export type AcceptConvertRes = {
        orderId:string,
        createTime:number,
        orderStatus:string //PROCESS/ACCEPT_SUCCESS/SUCCESS/FAIL
        }
    export interface Binance {
        getConvertPairSupported(options: {
            fromAsset: string
        }): Promise<ConvertPairSupport>;
        getConvertQuotes(options:{
            fromAsset: string,
            toAsset:string,
            fromAmount?: number,
            toAmmount?: number,

        }):Promise<GetConvertQuotesRes>;
        acceptConvert(options: {
            quoteId: string
        }):Promise<AcceptConvertRes>
